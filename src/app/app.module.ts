...
import { EncontrarempresaPipe } from './pipes/encontrarempresa.pipe';
import { ProductoSucursalPipe } from './pipes/producto-sucursal.pipe';
...
@NgModule({
  declarations: [
    ...
    BuscarPipe,
    EncontrarempresaPipe,
    ProductoSucursalPipe,
    SucursalPipe,
